...
## Related
- [Anonymous FTP enumeration playbook](../exploits/anonymous-ftp-enumeration.md)
- [PGP key cracking](../exploits/pgp-key-cracking.md) — typical follow-up after a backup drops
