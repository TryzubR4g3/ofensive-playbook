...
found the hidden `show=` parameter that turned into LFI -> Werkzeug PIN -> RCE. Full method: [hidden-parameter-fuzzing.md](../../exploits/web-disclosure/hidden-parameter-fuzzing.md).
...
enumerated the Gridmark application after adding the vhost locally.
