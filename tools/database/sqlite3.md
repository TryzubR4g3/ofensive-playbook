...
## Related
- [backup-file-exposure.md](../../exploits/web-disclosure/backup-file-exposure.md) — where `.db` and `.sql` files usually come from
- [strings](../reversing/strings.md) — last-resort fallback for unknown binary DBs
